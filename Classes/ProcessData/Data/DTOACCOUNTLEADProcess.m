...
-(NSMutableArray*) filterTop{
    ...
    NSString *query = [NSString stringWithFormat:@"Select %@ from %@ where status = 1 order by %@ desc LIMIT 1",[allFields componentsJoinedByString:@"," ] , TABLENAME_DTOACCOUNTLEAD, DTOLEAD_updatedDate];
