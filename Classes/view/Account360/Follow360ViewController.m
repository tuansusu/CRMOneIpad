...
@implementation Follow360ViewController
...
- (IBAction)actionSave:(id)sender {
    ...
    NSString *leadId=[_dataSend objectForKey:DTOACCOUNT_accountId] ;
    if (leadId.length>0) {
        [dicEntity setObject:[_dataSend objectForKey:DTOACCOUNT_accountId] forKey:DTOFOLLOWUP_objectId];
    }
    else{
        [dicEntity setObject:[_dataSend objectForKey:DTOACCOUNT_clientAccountId] forKey:DTOFOLLOWUP_objectId];
    }
    [dicEntity setObject:[_dataSend objectForKey:DTOLEAD_name] forKey:DTOFOLLOWUP_objectName];
    [dicEntity setObject:@"ACCOUNT" forKey:DTOFOLLOWUP_objectType];
