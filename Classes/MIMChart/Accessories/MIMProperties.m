...
//    minOfY=minOfY*pow(10, countDigits-1);
    ...
    else if ( 1000000.0<minOfY<=50000000.0)
    {
        minOfY=minOfY/pow(10, countDigits-2);
        minOfY=floorf(minOfY);
        minOfY=minOfY*pow(10, countDigits-2);
    ...
    {
        minOfY=minOfY/pow(10, countDigits-3);
        minOfY=floorf(minOfY);
        minOfY=minOfY*pow(10, countDigits-3);
...
+(float)findMinimumOnY:(float)minOfY
{
    ...
    {
        float minimumOnY=minOfY/pow(10, countDigits-2);
        minimumOnY=floorf(minimumOnY);
        minimumOnY=minimumOnY*pow(10, countDigits-2);
        return minimumOnY;
    }
    else
    {
        float minimumOnY=minOfY/pow(10, countDigits-3);
        minimumOnY=floorf(minimumOnY);
        minimumOnY=minimumOnY*pow(10, countDigits-3);
        return minimumOnY;
    }
 //This is the number with which labelling on y -Axis starts
}
