...
+ (NSArray *) RGBFromHex:(NSString *)hex {
    ...
    [[NSScanner scannerWithString:gString] scanHexInt:&green];
    [[NSScanner scannerWithString:bString] scanHexInt:&blue];
    return [NSArray arrayWithObjects:[NSString stringWithFormat:@"%d",red],[NSString stringWithFormat:@"%d",green],[NSString stringWithFormat:@"%d",blue], nil];
}
