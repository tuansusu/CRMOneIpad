...
typedef void (^GCNetworkRequestDataBlock)(NSData *downloadedData);
...
@property (nonatomic, strong) NSData *bodyContent;
...
@property (nonatomic, copy, readwrite) GCNetworkRequestDataBlock downloadedDataHandler;
