...
+ (id)requestWithURL:(NSURL *)anUrl withViewController : (BaseViewController*) viewController {
...
- (void)connection:(NSURLConnection *)connection didReceiveResponse:(NSURLResponse *)aResponse {
    ...
    self.filePath = [path stringByAppendingPathComponent:[NSString stringWithFormat: @"%@",fileName]];
    self._expectedContentLength = [(NSHTTPURLResponse *)aResponse expectedContentLength];
    
    //NSLog(@"length of file = %lld",self._expectedContentLength);
...
- (void)connection:(NSURLConnection *)connection didFailWithError:(NSError *)anError {   
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Thông báo" message:@"Quá trình tải bị gián đoạn, vui lòng tải lại" delegate:nil cancelButtonTitle:@"Thoát" otherButtonTitles: nil];
    [alert show];

    
    //NSLog(@"error download file");
