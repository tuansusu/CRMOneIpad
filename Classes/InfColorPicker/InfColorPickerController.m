...
- (void) viewDidLoad
{
    ...
    selectRed.frame = CGRectMake(270.0, 10.0, 30.0, 30.0);
    //[selectRed setTitle:@"OK" forState:UIControlStateNormal];
    [selectRed setImage:[UIImage imageNamed:@"Icon-Chon.png"] forState:UIControlStateNormal];
