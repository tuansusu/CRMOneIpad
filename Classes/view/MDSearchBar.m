...
- (void)initlayout
{
    self.textField.textColor = TEXT_COLOR_REPORT;
    self.textField.backgroundColor = BACKGROUND_NORMAL_COLOR1;
    self.textField.layer.borderColor = [BORDER_COLOR CGColor];
    self.textField.layer.borderWidth = BORDER_WITH;
