...
#define DTOLEAD_charter @"charter" //VARCHAR
...
#define DTONOTE_objectType @"objectType" //VARCHAR
///dtoattachment  Field
...
#define DTOATTACHMENT_clientObjectId @"clientObjectId" //bigint
///_dtoopportunityproduct_old_20150112  Field
#define _DTOOPPORTUNITYPRODUCT_OLD_20150112_clientOpportunityProductId @"clientOpportunityProductId" //BIGINT
#define _DTOOPPORTUNITYPRODUCT_OLD_20150112_createdBy @"createdBy" //BIGINT
#define _DTOOPPORTUNITYPRODUCT_OLD_20150112_createdDate @"createdDate" //VARCHAR
#define _DTOOPPORTUNITYPRODUCT_OLD_20150112_currencyId @"currencyId" //BIGINT
#define _DTOOPPORTUNITYPRODUCT_OLD_20150112_isActive @"isActive" //SMALLINT
#define _DTOOPPORTUNITYPRODUCT_OLD_20150112_opportunityId @"opportunityId" //BIGINT
#define _DTOOPPORTUNITYPRODUCT_OLD_20150112_opportunityProductId @"opportunityProductId" //BIGINT
#define _DTOOPPORTUNITYPRODUCT_OLD_20150112_productMasterId @"productMasterId" //BIGINT
#define _DTOOPPORTUNITYPRODUCT_OLD_20150112_quantity @"quantity" //VARCHAR
#define _DTOOPPORTUNITYPRODUCT_OLD_20150112_revenue @"revenue" //VARCHAR
#define _DTOOPPORTUNITYPRODUCT_OLD_20150112_updatedBy @"updatedBy" //BIGINT
#define _DTOOPPORTUNITYPRODUCT_OLD_20150112_updatedDate @"updatedDate" //VARCHAR
#define _DTOOPPORTUNITYPRODUCT_OLD_20150112_id @"id" //INTEGER
...
#define DTOACCOUNTCONTACT_clientContactId @"clientContactId" //bigint
///_dtoopportunitycontact_old_20150112  Field
#define _DTOOPPORTUNITYCONTACT_OLD_20150112_clientOpportunityContactId @"clientOpportunityContactId" //BIGINT
#define _DTOOPPORTUNITYCONTACT_OLD_20150112_contactId @"contactId" //BIGINT
#define _DTOOPPORTUNITYCONTACT_OLD_20150112_createdBy @"createdBy" //BIGINT
#define _DTOOPPORTUNITYCONTACT_OLD_20150112_createdDate @"createdDate" //VARCHAR
#define _DTOOPPORTUNITYCONTACT_OLD_20150112_isActive @"isActive" //SMALLINT
#define _DTOOPPORTUNITYCONTACT_OLD_20150112_opportunityContactId @"opportunityContactId" //BIGINT
#define _DTOOPPORTUNITYCONTACT_OLD_20150112_opportunityId @"opportunityId" //BIGINT
#define _DTOOPPORTUNITYCONTACT_OLD_20150112_updatedBy @"updatedBy" //BIGINT
#define _DTOOPPORTUNITYCONTACT_OLD_20150112_updatedDate @"updatedDate" //VARCHAR
#define _DTOOPPORTUNITYCONTACT_OLD_20150112_id @"id" //INTEGER
///dtocompetitor  Field
...
//#define DTOPRODUCTDETAIL_productdetailId @"productdetailId" //BIGINT
...
///dtormdailythanhtoan  Field
#define DTORMDAILYTHANHTOAN_id @"id" //BIGINT
#define DTORMDAILYTHANHTOAN_rm_code @"rm_code" //VARCHAR
#define DTORMDAILYTHANHTOAN_BUSSINESS_DATE @"BUSSINESS_DATE" //VARCHAR
#define DTORMDAILYTHANHTOAN_CREATED_DATE @"CREATED_DATE" //VARCHAR
#define DTORMDAILYTHANHTOAN_UPDATE_DATE @"UPDATE_DATE" //VARCHAR
#define DTORMDAILYTHANHTOAN_CURRENCY @"CURRENCY" //VARCHAR
#define DTORMDAILYTHANHTOAN_BALANCE @"BALANCE" //VARCHAR
#define DTORMDAILYTHANHTOAN_BALANCE_QD @"BALANCE_QD" //VARCHAR
#define DTORMDAILYTHANHTOAN_PRODUCT_CODE @"PRODUCT_CODE" //VARCHAR
#define DTORMDAILYTHANHTOAN_KHOI @"KHOI" //VARCHAR
#define DTORMDAILYTHANHTOAN_RM_BANCHEO @"RM_BANCHEO" //VARCHAR
///dtoRmMonthlyHDV  Field
#define DTORMMONTHLYHDV_ID @"ID" //BIGINT
#define DTORMMONTHLYHDV_RM_CODE @"RM_CODE" //VARCHAR
#define DTORMMONTHLYHDV_BUSSINESS_DATE @"BUSSINESS_DATE" //VARCHAR
#define DTORMMONTHLYHDV_CREATED_DATE @"CREATED_DATE" //VARCHAR
#define DTORMMONTHLYHDV_UPDATE_DATE @"UPDATE_DATE" //VARCHAR
#define DTORMMONTHLYHDV_CURRENCY @"CURRENCY" //VARCHAR
#define DTORMMONTHLYHDV_BALANCE @"BALANCE" //VARCHAR
#define DTORMMONTHLYHDV_BALANCE_QD @"BALANCE_QD" //VARCHAR
#define DTORMMONTHLYHDV_PRODUCT_CODE @"PRODUCT_CODE" //VARCHAR
#define DTORMMONTHLYHDV_PERIOD @"PERIOD" //SMALLINT
#define DTORMMONTHLYHDV_KHOI @"KHOI" //VARCHAR
#define DTORMMONTHLYHDV_RM_BANCHEO @"RM_BANCHEO" //VARCHAR
///dtoRmDailyTindung  Field
#define DTORMDAILYTINDUNG_ID @"ID" //BIGINT
#define DTORMDAILYTINDUNG_RM_CODE @"RM_CODE" //VARCHAR
#define DTORMDAILYTINDUNG_BUSSINESS_DATE @"BUSSINESS_DATE" //VARCHAR
#define DTORMDAILYTINDUNG_CREATED_DATE @"CREATED_DATE" //VARCHAR
#define DTORMDAILYTINDUNG_UPDATE_DATE @"UPDATE_DATE" //VARCHAR
#define DTORMDAILYTINDUNG_CURRENCY @"CURRENCY" //VARCHAR
#define DTORMDAILYTINDUNG_BALANCE @"BALANCE" //VARCHAR
#define DTORMDAILYTINDUNG_BALANCE_QD @"BALANCE_QD" //VARCHAR
#define DTORMDAILYTINDUNG_PRODUCT_CODE @"PRODUCT_CODE" //VARCHAR
#define DTORMDAILYTINDUNG_DEPT_GROUP @"DEPT_GROUP" //VARCHAR
#define DTORMDAILYTINDUNG_TERM @"TERM" //VARCHAR
#define DTORMDAILYTINDUNG_TERM_TYPE @"TERM_TYPE" //VARCHAR
#define DTORMDAILYTINDUNG_KHOI @"KHOI" //VARCHAR
#define DTORMDAILYTINDUNG_RM_BANCHEO @"RM_BANCHEO" //VARCHAR
///dtoRmMonthlyTindung  Field
#define DTORMMONTHLYTINDUNG_ID @"ID" //BIGINT
#define DTORMMONTHLYTINDUNG_RM_CODE @"RM_CODE" //VARCHAR
#define DTORMMONTHLYTINDUNG_BUSSINESS_DATE @"BUSSINESS_DATE" //VARCHAR
#define DTORMMONTHLYTINDUNG_CREATED_DATE @"CREATED_DATE" //VARCHAR
#define DTORMMONTHLYTINDUNG_UPDATE_DATE @"UPDATE_DATE" //VARCHAR
#define DTORMMONTHLYTINDUNG_CURRENCY @"CURRENCY" //VARCHAR
#define DTORMMONTHLYTINDUNG_BALANCE @"BALANCE" //VARCHAR
#define DTORMMONTHLYTINDUNG_BALANCE_QD @"BALANCE_QD" //VARCHAR
#define DTORMMONTHLYTINDUNG_PRODUCT_CODE @"PRODUCT_CODE" //VARCHAR
#define DTORMMONTHLYTINDUNG_DEPT_GROUP @"DEPT_GROUP" //VARCHAR
#define DTORMMONTHLYTINDUNG_TERM_TYPE @"TERM_TYPE" //VARCHAR
#define DTORMMONTHLYTINDUNG_TERM @"TERM" //VARCHAR
#define DTORMMONTHLYTINDUNG_KHOI @"KHOI" //VARCHAR
#define DTORMMONTHLYTINDUNG_RM_BANCHEO @"RM_BANCHEO" //VARCHAR
///dtoProTindungDetail  Field
#define DTOPROTINDUNGDETAIL_BRANCH_CODE @"BRANCH_CODE" //VARCHAR
#define DTOPROTINDUNGDETAIL_CONTRACT_NUMBER @"CONTRACT_NUMBER" //VARCHAR
#define DTOPROTINDUNGDETAIL_OPEN_DATE @"OPEN_DATE" //VARCHAR
#define DTOPROTINDUNGDETAIL_EXPIRE_DATE @"EXPIRE_DATE" //VARCHAR
#define DTOPROTINDUNGDETAIL_EXTENSION_DATE @"EXTENSION_DATE" //VARCHAR
#define DTOPROTINDUNGDETAIL_BALANCE @"BALANCE" //VARCHAR
#define DTOPROTINDUNGDETAIL_BALANCE_QD @"BALANCE_QD" //VARCHAR
#define DTOPROTINDUNGDETAIL_SOD_BALANCE @"SOD_BALANCE" //VARCHAR
#define DTOPROTINDUNGDETAIL_SOD_BALANCE_QD @"SOD_BALANCE_QD" //VARCHAR
#define DTOPROTINDUNGDETAIL_CURRENCY @"CURRENCY" //VARCHAR
#define DTOPROTINDUNGDETAIL_CLIENT_ID @"CLIENT_ID" //VARCHAR
#define DTOPROTINDUNGDETAIL_TERM @"TERM" //VARCHAR
#define DTOPROTINDUNGDETAIL_TERM_TYPE @"TERM_TYPE" //VARCHAR
#define DTOPROTINDUNGDETAIL_DEPT_GROUP @"DEPT_GROUP" //VARCHAR
#define DTOPROTINDUNGDETAIL_DEPT_GROUP2 @"DEPT_GROUP2" //VARCHAR
#define DTOPROTINDUNGDETAIL_FIXED_INTEREST @"FIXED_INTEREST" //VARCHAR
#define DTOPROTINDUNGDETAIL_INTEREST_MARGIN @"INTEREST_MARGIN" //VARCHAR
#define DTOPROTINDUNGDETAIL_INTEREST @"INTEREST" //VARCHAR
#define DTOPROTINDUNGDETAIL_RECEIVEABLE_AMOUNT @"RECEIVEABLE_AMOUNT" //VARCHAR
#define DTOPROTINDUNGDETAIL_STATUS @"STATUS" //VARCHAR
#define DTOPROTINDUNGDETAIL_BUSSINESS_DATE @"BUSSINESS_DATE" //VARCHAR
#define DTOPROTINDUNGDETAIL_INITIAL_BALANCE @"INITIAL_BALANCE" //VARCHAR
#define DTOPROTINDUNGDETAIL_PREPAID_INTEREST @"PREPAID_INTEREST" //VARCHAR
#define DTOPROTINDUNGDETAIL_OVERDUE_INTEREST @"OVERDUE_INTEREST" //VARCHAR
#define DTOPROTINDUNGDETAIL_SECTOR @"SECTOR" //VARCHAR
#define DTOPROTINDUNGDETAIL_SOURCE_OF_FUND @"SOURCE_OF_FUND" //VARCHAR
#define DTOPROTINDUNGDETAIL_SECURE @"SECURE" //VARCHAR
#define DTOPROTINDUNGDETAIL_GL @"GL" //VARCHAR
#define DTOPROTINDUNGDETAIL_INDUSTRY_CODE @"INDUSTRY_CODE" //VARCHAR
#define DTOPROTINDUNGDETAIL_INTEREST_TYPE @"INTEREST_TYPE" //VARCHAR
#define DTOPROTINDUNGDETAIL_INTEREST_KEY @"INTEREST_KEY" //VARCHAR
#define DTOPROTINDUNGDETAIL_INPUTTER @"INPUTTER" //VARCHAR
#define DTOPROTINDUNGDETAIL_PRODUCT_CODE @"PRODUCT_CODE" //VARCHAR
#define DTOPROTINDUNGDETAIL_RM_CODE @"RM_CODE" //VARCHAR
#define DTOPROTINDUNGDETAIL_KHOI @"KHOI" //VARCHAR
#define DTOPROTINDUNGDETAIL_RM_BANCHEO @"RM_BANCHEO" //VARCHAR
#define DTOPROTINDUNGDETAIL_PURPOSE @"PURPOSE" //VARCHAR
///dtocomplain  Field
#define DTOCOMPLAIN_casesid @"casesid" //INTEGER
...
#define DTOCOMPLAIN_status @"status" //INTEGER
#define DTOCOMPLAIN_fromreceived @"fromreceived" //SMALLINT
#define DTOCOMPLAIN_type @"type" //SMALLINT
#define DTOCOMPLAIN_priority @"priority" //SMALLINT
#define DTOCOMPLAIN_receiverid @"receiverid" //BIGINT
//#define DTOCOMPLAIN_receiveddate @"receiveddate" //VARCHAR
#define DTOCOMPLAIN_processerid @"processerid" //BIGINT
#define DTOCOMPLAIN_processeddate @"processeddate" //VARCHAR
#define DTOCOMPLAIN_closedid @"closedid" //BIGINT
#define DTOCOMPLAIN_closeddate @"closeddate" //VARCHAR
#define DTOCOMPLAIN_accountid @"accountid" //BIGINT
#define DTOCOMPLAIN_productmasterid @"productmasterid" //BIGINT
#define DTOCOMPLAIN_accepttypeid @"accepttypeid" //SMALLINT
...
#define DTOOPPORTUNITYCONTACT_clientOpportunityId @"clientOpportunityId" //INTEGER
#define DTOOPPORTUNITYCONTACT_clientContactId @"clientContactId" //INTEGER
...
#define DTOOPPORTUNITYPRODUCT_clientOpportunityId @"clientOpportunityId" //INTEGER
///dtoWidgetType  Field
#define DTOWIDGETTYPE_widgetId @"widgetId" //INTEGER
...
#define DTODASHBOARDCONFIGURATION_confId @"confId" //INTEGER
#define DTODASHBOARDCONFIGURATION_accountName @"accountName" //VARCHAR
#define DTODASHBOARDCONFIGURATION_typeGraphically @"typeGraphically" //VARCHAR
#define DTODASHBOARDCONFIGURATION_colorDisplay1 @"colorDisplay1" //VARCHAR
#define DTODASHBOARDCONFIGURATION_createDate @"createDate" //VARCHAR
#define DTODASHBOARDCONFIGURATION_isShowData @"isShowData" //VARCHAR
#define DTODASHBOARDCONFIGURATION_colorDisplay2 @"colorDisplay2" //VARCHAR
#define DTODASHBOARDCONFIGURATION_widgetId @"widgetId" //VARCHAR
#define DTODASHBOARDCONFIGURATION_widgetName @"widgetName" //VARCHAR
#define DTODASHBOARDCONFIGURATION_widgetType @"widgetType" //VARCHAR
#define DTODASHBOARDCONFIGURATION_status @"status" //VARCHAR
///dtoProThanhtoanDetail  Field
#define DTOPROTHANHTOANDETAIL_BRANCH_CODE @"BRANCH_CODE" //VARCHAR
#define DTOPROTHANHTOANDETAIL_CONTRACT_NUMBER @"CONTRACT_NUMBER" //VARCHAR
#define DTOPROTHANHTOANDETAIL_OPEN_DATE @"OPEN_DATE" //VARCHAR
#define DTOPROTHANHTOANDETAIL_EXPIRED_DATE @"EXPIRED_DATE" //VARCHAR
#define DTOPROTHANHTOANDETAIL_TRANSACTION_DATE @"TRANSACTION_DATE" //VARCHAR
#define DTOPROTHANHTOANDETAIL_BALANCE @"BALANCE" //VARCHAR
#define DTOPROTHANHTOANDETAIL_BALANCE_QD @"BALANCE_QD" //VARCHAR
#define DTOPROTHANHTOANDETAIL_CARD_FLAG @"CARD_FLAG" //VARCHAR
#define DTOPROTHANHTOANDETAIL_ACC_STATUS @"ACC_STATUS" //VARCHAR
#define DTOPROTHANHTOANDETAIL_SOD_BALANCE @"SOD_BALANCE" //VARCHAR
#define DTOPROTHANHTOANDETAIL_SOD_BALANCE_QD @"SOD_BALANCE_QD" //VARCHAR
#define DTOPROTHANHTOANDETAIL_CURRENCY @"CURRENCY" //VARCHAR
#define DTOPROTHANHTOANDETAIL_FOREX_RATE @"FOREX_RATE" //VARCHAR
#define DTOPROTHANHTOANDETAIL_CLIENT_ID @"CLIENT_ID" //VARCHAR
#define DTOPROTHANHTOANDETAIL_TERM_DAY @"TERM_DAY" //VARCHAR
#define DTOPROTHANHTOANDETAIL_TERM_WEEK @"TERM_WEEK" //VARCHAR
#define DTOPROTHANHTOANDETAIL_TERM_TXT @"TERM_TXT" //VARCHAR
#define DTOPROTHANHTOANDETAIL_SUSPEND_INTEREST @"SUSPEND_INTEREST" //VARCHAR
#define DTOPROTHANHTOANDETAIL_INTEREST @"INTEREST" //VARCHAR
#define DTOPROTHANHTOANDETAIL_LINE_T24 @"LINE_T24" //VARCHAR
#define DTOPROTHANHTOANDETAIL_INDUSTRY_CODE @"INDUSTRY_CODE" //VARCHAR
#define DTOPROTHANHTOANDETAIL_SECTOR @"SECTOR" //VARCHAR
#define DTOPROTHANHTOANDETAIL_GL @"GL" //VARCHAR
#define DTOPROTHANHTOANDETAIL_PRODUCT_CODE @"PRODUCT_CODE" //VARCHAR
#define DTOPROTHANHTOANDETAIL_RM_CODE @"RM_CODE" //VARCHAR
#define DTOPROTHANHTOANDETAIL_BUSSINESS_DATE @"BUSSINESS_DATE" //VARCHAR
#define DTOPROTHANHTOANDETAIL_KHOI @"KHOI" //VARCHAR
///dtoProTietkiemDetail  Field
#define DTOPROTIETKIEMDETAIL_BRANCH_CODE @"BRANCH_CODE" //VARCHAR
#define DTOPROTIETKIEMDETAIL_CONTRACT_NUMBER @"CONTRACT_NUMBER" //VARCHAR
#define DTOPROTIETKIEMDETAIL_OPEN_DATE @"OPEN_DATE" //VARCHAR
#define DTOPROTIETKIEMDETAIL_EXPIRED_DATE @"EXPIRED_DATE" //VARCHAR
#define DTOPROTIETKIEMDETAIL_TRANSACTION_DATE @"TRANSACTION_DATE" //VARCHAR
#define DTOPROTIETKIEMDETAIL_BALANCE @"BALANCE" //VARCHAR
#define DTOPROTIETKIEMDETAIL_BALANCE_QD @"BALANCE_QD" //VARCHAR
#define DTOPROTIETKIEMDETAIL_CARD_FLAG @"CARD_FLAG" //VARCHAR
#define DTOPROTIETKIEMDETAIL_ACC_STATUS @"ACC_STATUS" //VARCHAR
#define DTOPROTIETKIEMDETAIL_SOD_BALANCE @"SOD_BALANCE" //VARCHAR
#define DTOPROTIETKIEMDETAIL_SOD_BALANCE_QD @"SOD_BALANCE_QD" //VARCHAR
#define DTOPROTIETKIEMDETAIL_CURRENCY @"CURRENCY" //VARCHAR
#define DTOPROTIETKIEMDETAIL_CLIENT_ID @"CLIENT_ID" //VARCHAR
#define DTOPROTIETKIEMDETAIL_TERM_DAY @"TERM_DAY" //VARCHAR
#define DTOPROTIETKIEMDETAIL_TERM_WEEK @"TERM_WEEK" //VARCHAR
#define DTOPROTIETKIEMDETAIL_TERM_TXT @"TERM_TXT" //VARCHAR
#define DTOPROTIETKIEMDETAIL_SUSPEND_INTEREST @"SUSPEND_INTEREST" //VARCHAR
#define DTOPROTIETKIEMDETAIL_INTEREST @"INTEREST" //VARCHAR
#define DTOPROTIETKIEMDETAIL_EXPENSE_INTEREST @"EXPENSE_INTEREST" //VARCHAR
#define DTOPROTIETKIEMDETAIL_LINE_T24 @"LINE_T24" //VARCHAR
#define DTOPROTIETKIEMDETAIL_INDUSTRY_CODE @"INDUSTRY_CODE" //VARCHAR
#define DTOPROTIETKIEMDETAIL_SECTOR @"SECTOR" //VARCHAR
#define DTOPROTIETKIEMDETAIL_GL @"GL" //VARCHAR
#define DTOPROTIETKIEMDETAIL_PRODUCT_CODE @"PRODUCT_CODE" //VARCHAR
#define DTOPROTIETKIEMDETAIL_RM_CODE @"RM_CODE" //VARCHAR
#define DTOPROTIETKIEMDETAIL_BUSSINESS_DATE @"BUSSINESS_DATE" //VARCHAR
#define DTOPROTIETKIEMDETAIL_KHOI @"KHOI" //VARCHAR
///dtoProBaolanhDetail  Field
#define DTOPROBAOLANHDETAIL_BRANCH_CODE @"BRANCH_CODE" //VARCHAR
#define DTOPROBAOLANHDETAIL_CONTRACT_NUMBER @"CONTRACT_NUMBER" //VARCHAR
#define DTOPROBAOLANHDETAIL_CATEGORY @"CATEGORY" //VARCHAR
#define DTOPROBAOLANHDETAIL_REF @"REF" //VARCHAR
#define DTOPROBAOLANHDETAIL_CLIENT_ID @"CLIENT_ID" //VARCHAR
#define DTOPROBAOLANHDETAIL_SECTOR @"SECTOR" //VARCHAR
#define DTOPROBAOLANHDETAIL_INDUSTRY_CODE @"INDUSTRY_CODE" //VARCHAR
#define DTOPROBAOLANHDETAIL_CURRENCY @"CURRENCY" //VARCHAR
#define DTOPROBAOLANHDETAIL_BALANCE @"BALANCE" //VARCHAR
#define DTOPROBAOLANHDETAIL_OPEN_DATE @"OPEN_DATE" //VARCHAR
#define DTOPROBAOLANHDETAIL_VALUE_DATE @"VALUE_DATE" //VARCHAR
#define DTOPROBAOLANHDETAIL_EXPIRE_DATE @"EXPIRE_DATE" //VARCHAR
#define DTOPROBAOLANHDETAIL_MD_FREE @"MD_FREE" //VARCHAR
#define DTOPROBAOLANHDETAIL_MARGIN @"MARGIN" //VARCHAR
#define DTOPROBAOLANHDETAIL_MARGIN_AMOUNT @"MARGIN_AMOUNT" //VARCHAR
#define DTOPROBAOLANHDETAIL_RECEIVER_CODE @"RECEIVER_CODE" //VARCHAR
#define DTOPROBAOLANHDETAIL_RECEIVER_NAME @"RECEIVER_NAME" //VARCHAR
#define DTOPROBAOLANHDETAIL_UPDATE_LIMIT @"UPDATE_LIMIT" //VARCHAR
#define DTOPROBAOLANHDETAIL_PROVISION @"PROVISION" //VARCHAR
#define DTOPROBAOLANHDETAIL_MARGIN_FLAG @"MARGIN_FLAG" //VARCHAR
#define DTOPROBAOLANHDETAIL_MARGIN2 @"MARGIN2" //VARCHAR
#define DTOPROBAOLANHDETAIL_LIQUIDATION_MODE @"LIQUIDATION_MODE" //VARCHAR
#define DTOPROBAOLANHDETAIL_FEE_TYPE @"FEE_TYPE" //VARCHAR
#define DTOPROBAOLANHDETAIL_FREQUENCY @"FREQUENCY" //VARCHAR
#define DTOPROBAOLANHDETAIL_AUTO_EXPIRE @"AUTO_EXPIRE" //VARCHAR
#define DTOPROBAOLANHDETAIL_BUSSINESS_DATE @"BUSSINESS_DATE" //VARCHAR
#define DTOPROBAOLANHDETAIL_CMS_DATE @"CMS_DATE" //VARCHAR
#define DTOPROBAOLANHDETAIL_CMS_AMT @"CMS_AMT" //VARCHAR
#define DTOPROBAOLANHDETAIL_DESCRIPTION @"DESCRIPTION" //VARCHAR
#define DTOPROBAOLANHDETAIL_INITIAL_MARGIN @"INITIAL_MARGIN" //VARCHAR
#define DTOPROBAOLANHDETAIL_BALANCE_QD @"BALANCE_QD" //VARCHAR
#define DTOPROBAOLANHDETAIL_FOREX_RATE @"FOREX_RATE" //VARCHAR
#define DTOPROBAOLANHDETAIL_PRODUCT_CODE @"PRODUCT_CODE" //VARCHAR
#define DTOPROBAOLANHDETAIL_RM_CODE @"RM_CODE" //VARCHAR
#define DTOPROBAOLANHDETAIL_KHOI @"KHOI" //VARCHAR
#define DTOPROBAOLANHDETAIL_RM_BANCHEO @"RM_BANCHEO" //VARCHAR
///dtoProTTQTDetail  Field
#define DTOPROTTQTDETAIL_BRANCH_CODE @"BRANCH_CODE" //VARCHAR
#define DTOPROTTQTDETAIL_CONTRACT_NUMBER @"CONTRACT_NUMBER" //VARCHAR
#define DTOPROTTQTDETAIL_CLIENT_ID @"CLIENT_ID" //VARCHAR
#define DTOPROTTQTDETAIL_LC_TYPE @"LC_TYPE" //VARCHAR
#define DTOPROTTQTDETAIL_IMP_EXP @"IMP_EXP" //VARCHAR
#define DTOPROTTQTDETAIL_ISSUE_DATE @"ISSUE_DATE" //VARCHAR
#define DTOPROTTQTDETAIL_LC_CCY @"LC_CCY" //VARCHAR
#define DTOPROTTQTDETAIL_LC_AMOUNT @"LC_AMOUNT" //VARCHAR
#define DTOPROTTQTDETAIL_LC_AMOUNT_USD @"LC_AMOUNT_USD" //VARCHAR
#define DTOPROTTQTDETAIL_OUT_TYPE @"OUT_TYPE" //VARCHAR
#define DTOPROTTQTDETAIL_OUT_CCY @"OUT_CCY" //VARCHAR
#define DTOPROTTQTDETAIL_OUT_AMOUNT @"OUT_AMOUNT" //VARCHAR
#define DTOPROTTQTDETAIL_OUT_AMOUNT_USD @"OUT_AMOUNT_USD" //VARCHAR
#define DTOPROTTQTDETAIL_OUT_VALUE_DATE @"OUT_VALUE_DATE" //VARCHAR
#define DTOPROTTQTDETAIL_STATUS @"STATUS" //VARCHAR
#define DTOPROTTQTDETAIL_SECTOR @"SECTOR" //VARCHAR
#define DTOPROTTQTDETAIL_BUSSINESS_DATE @"BUSSINESS_DATE" //VARCHAR
#define DTOPROTTQTDETAIL_CREATED_DATE @"CREATED_DATE" //VARCHAR
#define DTOPROTTQTDETAIL_UPDATE_DATE @"UPDATE_DATE" //VARCHAR
#define DTOPROTTQTDETAIL_PRODUCT_CODE @"PRODUCT_CODE" //VARCHAR
#define DTOPROTTQTDETAIL_RM_CODE @"RM_CODE" //VARCHAR
#define DTOPROTTQTDETAIL_KHOI @"KHOI" //VARCHAR
#define DTOPROTTQTDETAIL_RM_BANCHEO @"RM_BANCHEO" //VARCHAR
///dtoProWay4Detail  Field
#define DTOPROWAY4DETAIL_CARD_NUMBER @"CARD_NUMBER" //VARCHAR
#define DTOPROWAY4DETAIL_CARD_HOLDER_NAME @"CARD_HOLDER_NAME" //VARCHAR
#define DTOPROWAY4DETAIL_CLIENT_ID @"CLIENT_ID" //VARCHAR
#define DTOPROWAY4DETAIL_CURRENT_ACCOUNT @"CURRENT_ACCOUNT" //VARCHAR
#define DTOPROWAY4DETAIL_PRODUCT_CODE @"PRODUCT_CODE" //VARCHAR
#define DTOPROWAY4DETAIL_BRANCH_CODE @"BRANCH_CODE" //VARCHAR
#define DTOPROWAY4DETAIL_OPEN_DATE @"OPEN_DATE" //VARCHAR
#define DTOPROWAY4DETAIL_EXPIRE_DATE @"EXPIRE_DATE" //VARCHAR
#define DTOPROWAY4DETAIL_AVAIABLE @"AVAIABLE" //VARCHAR
#define DTOPROWAY4DETAIL_BLOCKED @"BLOCKED" //VARCHAR
#define DTOPROWAY4DETAIL_BALANCE @"BALANCE" //VARCHAR
#define DTOPROWAY4DETAIL_STATUS @"STATUS" //VARCHAR
#define DTOPROWAY4DETAIL_TYPE @"TYPE" //VARCHAR
#define DTOPROWAY4DETAIL_BUSSINESS_DATE @"BUSSINESS_DATE" //VARCHAR
#define DTOPROWAY4DETAIL_CREATED_DATE @"CREATED_DATE" //VARCHAR
#define DTOPROWAY4DETAIL_UPDATED_DATE @"UPDATED_DATE" //VARCHAR
#define DTOPROWAY4DETAIL_RM_CODE @"RM_CODE" //VARCHAR
#define DTOPROWAY4DETAIL_CONTRACT_NUMBER @"CONTRACT_NUMBER" //VARCHAR
///dtoProBPDetail  Field
#define DTOPROBPDETAIL_CONTRACT_NUMBER @"CONTRACT_NUMBER" //VARCHAR
#define DTOPROBPDETAIL_BRANCH_CODE @"BRANCH_CODE" //VARCHAR
#define DTOPROBPDETAIL_REGISTER_MOBILE @"REGISTER_MOBILE" //VARCHAR
#define DTOPROBPDETAIL_ACCOUNT @"ACCOUNT" //VARCHAR
#define DTOPROBPDETAIL_CIF @"CIF" //VARCHAR
#define DTOPROBPDETAIL_CLIENT_ID @"CLIENT_ID" //VARCHAR
#define DTOPROBPDETAIL_PRODUCT_CODE @"PRODUCT_CODE" //VARCHAR
#define DTOPROBPDETAIL_REGISTER_DATE @"REGISTER_DATE" //VARCHAR
#define DTOPROBPDETAIL_BP_UPDATE_DATE @"BP_UPDATE_DATE" //VARCHAR
#define DTOPROBPDETAIL_STATUS @"STATUS" //VARCHAR
#define DTOPROBPDETAIL_BUSSINESS_DATE @"BUSSINESS_DATE" //VARCHAR
#define DTOPROBPDETAIL_CREATED_DATE @"CREATED_DATE" //VARCHAR
#define DTOPROBPDETAIL_UPDATED_DATE @"UPDATED_DATE" //VARCHAR
#define DTOPROBPDETAIL_RM_CODE @"RM_CODE" //VARCHAR
///dtoProEMBDetail  Field
#define DTOPROEMBDETAIL_CONTRACT_NUMBER @"CONTRACT_NUMBER" //VARCHAR
#define DTOPROEMBDETAIL_PRODUCT_CODE @"PRODUCT_CODE" //VARCHAR
#define DTOPROEMBDETAIL_CLIENT_ID @"CLIENT_ID" //VARCHAR
#define DTOPROEMBDETAIL_BRANCH_CODE @"BRANCH_CODE" //VARCHAR
#define DTOPROEMBDETAIL_CMT @"CMT" //VARCHAR
#define DTOPROEMBDETAIL_START_DATE @"START_DATE" //VARCHAR
#define DTOPROEMBDETAIL_END_DATE @"END_DATE" //VARCHAR
#define DTOPROEMBDETAIL_BUSSINESS_DATE @"BUSSINESS_DATE" //VARCHAR
#define DTOPROEMBDETAIL_CREATED_DATE @"CREATED_DATE" //VARCHAR
#define DTOPROEMBDETAIL_UPDATE_DATE @"UPDATE_DATE" //VARCHAR
#define DTOPROEMBDETAIL_RM_CODE @"RM_CODE" //VARCHAR
///dtoRmDailyTietkiem  Field
#define DTORMDAILYTIETKIEM_RM_CODE @"RM_CODE" //VARCHAR
#define DTORMDAILYTIETKIEM_BUSSINESS_DATE @"BUSSINESS_DATE" //VARCHAR
#define DTORMDAILYTIETKIEM_CREATED_DATE @"CREATED_DATE" //VARCHAR
#define DTORMDAILYTIETKIEM_UPDATE_DATE @"UPDATE_DATE" //VARCHAR
#define DTORMDAILYTIETKIEM_CURRENCY @"CURRENCY" //VARCHAR
#define DTORMDAILYTIETKIEM_BALANCE @"BALANCE" //VARCHAR
#define DTORMDAILYTIETKIEM_BALANCE_QD @"BALANCE_QD" //VARCHAR
#define DTORMDAILYTIETKIEM_PRODUCT_CODE @"PRODUCT_CODE" //VARCHAR
#define DTORMDAILYTIETKIEM_TERM @"TERM" //VARCHAR
#define DTORMDAILYTIETKIEM_KHOI @"KHOI" //VARCHAR
#define DTORMDAILYTIETKIEM_RM_BANCHEO @"RM_BANCHEO" //VARCHAR
///dtoRmDailyThanhToan1  Field
#define DTORMDAILYTHANHTOAN1_RM_CODE @"RM_CODE" //VARCHAR
#define DTORMDAILYTHANHTOAN1_BUSSINESS_DATE @"BUSSINESS_DATE" //VARCHAR
#define DTORMDAILYTHANHTOAN1_CREATED_DATE @"CREATED_DATE" //VARCHAR
#define DTORMDAILYTHANHTOAN1_UPDATE_DATE @"UPDATE_DATE" //VARCHAR
#define DTORMDAILYTHANHTOAN1_CURRENCY @"CURRENCY" //VARCHAR
#define DTORMDAILYTHANHTOAN1_BALANCE @"BALANCE" //VARCHAR
#define DTORMDAILYTHANHTOAN1_BALANCE_QD @"BALANCE_QD" //VARCHAR
#define DTORMDAILYTHANHTOAN1_PRODUCT_CODE @"PRODUCT_CODE" //VARCHAR
#define DTORMDAILYTHANHTOAN1_KHOI @"KHOI" //VARCHAR
#define DTORMDAILYTHANHTOAN1_RM_BANCHEO @"RM_BANCHEO" //VARCHAR
